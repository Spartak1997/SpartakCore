...
public class GT_Loader_Items
{
	...
	private void registerItems()
	{
		...
		CustomItemList.HeavyDutyNoseConeTier5.set(ItemList.HeavyDutyNoseConeTier5.getIS());
		CustomItemList.HeavyDutyNoseConeTier6.set(ItemList.HeavyDutyNoseConeTier6.getIS());
		CustomItemList.HeavyDutyNoseConeTier7.set(ItemList.HeavyDutyNoseConeTier7.getIS());
		CustomItemList.HeavyDutyNoseConeTier8.set(ItemList.HeavyDutyNoseConeTier8.getIS());
		CustomItemList.HeavyDutyRocketEngineTier4.set(ItemList.HeavyDutyRocketEngineTier4.getIS());
		CustomItemList.HeavyDutyRocketEngineTier5.set(ItemList.HeavyDutyRocketEngineTier5.getIS());
		CustomItemList.HeavyDutyRocketEngineTier6.set(ItemList.HeavyDutyRocketEngineTier6.getIS());
		CustomItemList.HeavyDutyRocketEngineTier7.set(ItemList.HeavyDutyRocketEngineTier7.getIS());
		CustomItemList.HeavyDutyRocketEngineTier8.set(ItemList.HeavyDutyRocketEngineTier8.getIS());
		CustomItemList.HeavyDutyRocketFinsTier4.set(ItemList.HeavyDutyRocketFinsTier4.getIS());
		CustomItemList.HeavyDutyRocketFinsTier5.set(ItemList.HeavyDutyRocketFinsTier5.getIS());
		CustomItemList.HeavyDutyRocketFinsTier6.set(ItemList.HeavyDutyRocketFinsTier6.getIS());
		CustomItemList.HeavyDutyRocketFinsTier7.set(ItemList.HeavyDutyRocketFinsTier7.getIS());
		CustomItemList.HeavyDutyRocketFinsTier8.set(ItemList.HeavyDutyRocketFinsTier8.getIS());
		CustomItemList.Tier4Booster.set(ItemList.Tier4Booster.getIS());
		CustomItemList.Tier5Booster.set(ItemList.Tier5Booster.getIS());
