package com.spartakcore.gthandler.tileentities.basic.gui;
...
public class GT_GUIContainer_Water extends GT_GUIContainerMetaTile_Machine {

    private final String mName;

    public GT_GUIContainer_Water(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity, String aName) {
